"""remove the DHv2 technical-tool feature

Revision ID: 0020_remove_dhv2
Revises: 0019_service_workflow_extensions
...
revision = "0020_remove_dhv2"
down_revision = "0019_service_workflow_extensions"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    op.create_table(
        ...
        sa.Column("task_no", sa.String(length=48), nullable=False, unique=True),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column("technical_tool_task_id", sa.Integer(), sa.ForeignKey("technical_tool_tasks.id"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column("device_id", sa.Integer(), sa.ForeignKey("drone_devices.id"), nullable=False, unique=True),
        sa.Column("technical_tool_task_id", sa.Integer(), sa.ForeignKey("technical_tool_tasks.id"), nullable=False, unique=True),
    ...
    op.create_index("ix_technical_tool_locks_technical_tool_task_id", "technical_tool_locks", ["technical_tool_task_id"])
