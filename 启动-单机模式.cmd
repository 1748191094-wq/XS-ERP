...
exit /b 1
:venv
".venv\Scripts\python.exe" scripts\windows_launcher.py host --standalone --no-browser
goto finish
:localpython
"%LocalAppData%\Programs\Python\Python311\python.exe" scripts\windows_launcher.py host --standalone --no-browser
goto finish
:py
py -3 scripts\windows_launcher.py host --standalone --no-browser
goto finish
:python
python scripts\windows_launcher.py host --standalone --no-browser
goto finish
:finish
